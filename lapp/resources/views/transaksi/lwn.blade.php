...
<div class="form-group">
    <label for="exampleFormControlSelect1">LWN Field</label>
    <select class="form-control" name="standar" data-style="btn btn-link" id="lwn_menu">
        <option>Pilih Standar</option>
        <option value="standar_a">Standar A,B,C</option>
        <option value="standar_d">Standar D</option>
    </select>
    <input type="hidden" value="lwn" name="menu">
</div>
<div class="form-group">
