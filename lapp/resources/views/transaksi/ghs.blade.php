...
<div class="form-group">
    ...
    <select class="form-control" name="standar" data-style="btn btn-link" id="ghs_menu">
        <option>Pilih Standar</option>
        <option value="standar_a">Standard Package</option>
        <option value="standar_d">Deluxe Package</option>
    </select>
