...
<div class="form-group">
    <label for="exampleFormControlSelect1">HBW Field</label>
    <select class="form-control" name="standar" data-style="btn btn-link" id="hbw_menu">
